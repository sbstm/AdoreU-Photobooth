...
import Frame from '../public/Frame 99.png'
import Subtract from '../public/Subtract.png'
import card1 from '../public/Group 100.png'
import card2 from '../public/Group 99.png'
import card3 from '../public/Group 98.png'
      ...
      <div className="p-8">
        <div className="text-white">
          ...
          <div className="text-blue-900">
            <Image alt="" className="mt-10" src={Frame} />
            <div className="grid gap-4 grid-cols-2 mb-10 ">
              <div>
                <p className="pt-6 ml-10 mt-6 text-blue-900">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quae
                  quasi, repellat nam quis porro animi facere, tempora, quisquam
                  fuga impedit provident adipisci veritatis quas omnis.
                  Possimus, fugiat commodi! Eos, illo?.
                </p>
              </div>
              <div></div>
              <div></div>
              <div>
                <p className="pr-4 pt-6 mr-4 mt-6 text-blue-900">
                  Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quae
                  quasi, repellat nam quis porro animi facere, tempora, quisquam
                  fuga impedit provident adipisci veritatis quas omnis.
                  Possimus, fugiat commodi! Eos, illo?.
            ...
            <div>
              <div className="text-center pt-5">
                <h1 className="text-2xl font-family italic">
                  B &nbsp; E &nbsp;N &nbsp;E &nbsp;F &nbsp;I &nbsp;T &nbsp;S
                </h1>
                <Image alt="" className="lg-center" src={Subtract} />
            ...
            <div className="grid grid-flow-row-dense grid-cols-3 mt-10 pt-10 text-center">
              ...
              <div>
                <h1 className="text-2xl font-family italic">
                  {' '}
                  T I N Y P A C K A G E{' '}
                </h1>
                <h2 className="mt-4">
                  {' '}
                  2 HOURS UNLIMITED (50pcs 4r/100pcs 2r){' '}
                </h2>
                <h2> 1.749.000 </h2>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 text-center mb-10">
              <div>
                <Image alt="" className="mt-10 w-80 h-96 ml-10" src={card3} />
                <h1>
                  WEDDING - display the result of
                  <br />
                  your photos documentation
                </h1>
              </div>
              <div>
                <Image alt="" className="mt-10 w-80 h-96  ml-10" src={card2} />
                <h1>
                  BIRTHDAY - makes unfotgettable <br />
                  memories with friends on your <br />
                  birthday
                </h1>
              </div>
              <div>
                <Image alt="" className="mt-10 w-80 h-96 ml-10" src={card1} />
                <h1>
                  WEDDING - share happiness with <br /> the beautiful memories
                  on your <br />
                  special day
                </h1>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-15 pt-10 text-center ">
                ...
                <div>
                  <button className=" border-2  border-solid rounded-full border-blue-900 mb-10">
                    {' '}
                    <h1 className="mx-5 my-2">CONTACT</h1>{' '}
                  </button>
                </div>
